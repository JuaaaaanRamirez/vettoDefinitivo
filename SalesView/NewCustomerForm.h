...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			// label12
			// 
			this->label12->BackColor = System::Drawing::Color::FromArgb(static_cast<System::Int32>(static_cast<System::Byte>(166)), static_cast<System::Int32>(static_cast<System::Byte>(151)),
			...
			this->label12->Size = System::Drawing::Size(788, 60);
			...
			// btnRegister
			// 
			this->btnRegister->Location = System::Drawing::Point(229, 553);
			...
			// btnBack
			// 
			this->btnBack->Location = System::Drawing::Point(503, 553);
			...
			this->pbCustomer->Location = System::Drawing::Point(540, 73);
			this->pbCustomer->Margin = System::Windows::Forms::Padding(4);
			this->pbCustomer->Name = L"pbCustomer";
			this->pbCustomer->Size = System::Drawing::Size(155, 171);
			...
			// btnPhoto
			// 
			this->btnPhoto->Location = System::Drawing::Point(540, 262);
			this->btnPhoto->Margin = System::Windows::Forms::Padding(4);
			this->btnPhoto->Name = L"btnPhoto";
			this->btnPhoto->Size = System::Drawing::Size(144, 28);
			this->btnPhoto->TabIndex = 16;
			this->btnPhoto->Text = L"Agregar imagen";
			this->btnPhoto->UseVisualStyleBackColor = true;
			this->btnPhoto->Click += gcnew System::EventHandler(this, &NewCustomerForm::btnPhoto_Click);
			// 
			// NewCustomerForm
			// 
			...
			this->ClientSize = System::Drawing::Size(788, 608);
